...
def main():
    ...
    df_by_resi_mean = pd.merge(df_by_resi_mean_P1_Calu3_noAb, df_by_resi_mean_P1_E6_noAb, on='resi', how='outer')
    ...
    df_by_resi = df_by_resi[['resi','pos','count','mean_fit_P1-Calu3_noAb','mean_fit_P1-E6_noAb',
