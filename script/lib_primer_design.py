...
def main():
    ...
    template = open('Fasta/SARS2-FP_with_flank.fa', 'r').readlines()[1].rstrip().upper()
    cassettes = range(0,6,1) #cassettes = range(0,N,1), where N is the number of cassattes needed
    F_output_file = 'primer/SARS2-FP_lib_Fprimer_bc.fa'
    R_output_file = 'primer/SARS2-FP_lib_Rprimer_bc.fa'
